...
const Login = () => {
  ...
  const handleLogin = () => {
    sessionStorage.setItem("matrip_role", "admin");
    navigate("/admin");
  };
  ...
  return (
    <div
      ...
      <div
        ...
        <h2 className="text-2xl font-bold mb-1" style={{ color: "hsl(var(--foreground))" }}>Bem-vindo (a) de volta
        ...
        <div className="mb-2">
          ...
          <div
            ...
            <Lock size={18} style={{ color: DARK_BLUE }} />
            <input
        ...
        <div className="flex justify-end mb-8">
          <button type="button" className="text-sm font-medium" style={{ color: DARK_BLUE }} onClick={() => navigate("/forgot-password")}>
            Esqueceu a senha?
          </button>
        </div>
        ...
        <button
          type="button"
          onClick={handleLogin}
          className="w-full flex items-center justify-center gap-2 rounded-xl py-4 text-base font-semibold shadow-lg active:scale-95 transition-transform"
          style={{
            background: DARK_BLUE,
            color: "#fff",
        ...
        <p className="text-center text-sm mt-8" style={{ color: "hsl(var(--muted-foreground))" }}>
          Não tem uma conta?{" "}
          <button type="button" className="font-semibold" style={{ color: DARK_BLUE }} onClick={() => navigate("/register")}>
            Cadastre-se grátis
          </button>
        </p>
      </div>
